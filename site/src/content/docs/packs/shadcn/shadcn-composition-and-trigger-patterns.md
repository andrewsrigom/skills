---
title: "shadcn Composition And Trigger Patterns"
...
> Source: [`shadcn/shadcn-composition-and-trigger-patterns/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/shadcn/shadcn-composition-and-trigger-patterns/SKILL.md)
