---
title: "shadcn CLI Registry And components.json"
...
> Source: [`shadcn/shadcn-cli-registry-and-components-json/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/shadcn/shadcn-cli-registry-and-components-json/SKILL.md)
