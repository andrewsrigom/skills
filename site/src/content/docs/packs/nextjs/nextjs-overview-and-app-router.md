---
title: "Next.js Overview and App Router"
...
> Source: [`nextjs/nextjs-overview-and-app-router/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/nextjs/nextjs-overview-and-app-router/SKILL.md)
...
1. Read [references/docs-map-and-starting-points.md](/packs/nextjs/nextjs-overview-and-app-router/references/docs-map-and-starting-points/) first.
