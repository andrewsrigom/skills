---
title: "Next.js Data Fetching and Cache"
...
> Source: [`nextjs/nextjs-data-fetching-and-cache/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/nextjs/nextjs-data-fetching-and-cache/SKILL.md)
...
1. Read [references/cache-and-revalidation-matrix.md](/packs/nextjs/nextjs-data-fetching-and-cache/references/cache-and-revalidation-matrix/) first.
