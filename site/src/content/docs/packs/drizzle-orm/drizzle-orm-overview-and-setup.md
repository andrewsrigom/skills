---
title: "Drizzle ORM Overview and Setup"
...
> Source: [`drizzle-orm/drizzle-orm-overview-and-setup/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/drizzle-orm/drizzle-orm-overview-and-setup/SKILL.md)
...
1. Read [references/docs-map.md](/packs/drizzle-orm/drizzle-orm-overview-and-setup/references/docs-map/) first.
2. If the task mentions versions, the v1 beta line, or validator-package imports, read [references/package-and-upgrade-snapshot.md](/packs/drizzle-orm/drizzle-orm-overview-and-setup/references/package-and-upgrade-snapshot/).
