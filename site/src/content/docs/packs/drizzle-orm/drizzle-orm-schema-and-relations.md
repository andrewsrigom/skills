---
title: "Drizzle ORM Schema and Relations"
...
> Source: [`drizzle-orm/drizzle-orm-schema-and-relations/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/drizzle-orm/drizzle-orm-schema-and-relations/SKILL.md)
...
1. Read [references/schema-design.md](/packs/drizzle-orm/drizzle-orm-schema-and-relations/references/schema-design/) first.
2. If the task touches relations, advanced schema entities, or beta-only relation APIs, read [references/relations-and-advanced-schema.md](/packs/drizzle-orm/drizzle-orm-schema-and-relations/references/relations-and-advanced-schema/).
