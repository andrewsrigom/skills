---
title: "Drizzle ORM Queries and SQL"
...
> Source: [`drizzle-orm/drizzle-orm-queries-and-sql/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/drizzle-orm/drizzle-orm-queries-and-sql/SKILL.md)
...
1. Read [references/query-patterns.md](/packs/drizzle-orm/drizzle-orm-queries-and-sql/references/query-patterns/) first.
2. If the task touches transactions, batch, cache, read replicas, or query-builder reuse, read [references/advanced-query-features.md](/packs/drizzle-orm/drizzle-orm-queries-and-sql/references/advanced-query-features/).
