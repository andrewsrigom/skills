---
title: "Drizzle Kit Command Reference"
description: "Supporting reference for Drizzle ORM Migrations and Drizzle Kit."
slug: "packs/drizzle-orm/drizzle-orm-migrations-and-drizzle-kit/references/drizzle-kit-command-reference"
sidebar:
  hidden: true
---
> Pack: [`drizzle-orm`](/packs/drizzle-orm/)
> Parent skill: [Drizzle ORM Migrations and Drizzle Kit](/packs/drizzle-orm/drizzle-orm-migrations-and-drizzle-kit/)
> Source: [`drizzle-orm/drizzle-orm-migrations-and-drizzle-kit/references/drizzle-kit-command-reference.md`](https://github.com/andrewsrigom/agent-skills/blob/main/drizzle-orm/drizzle-orm-migrations-and-drizzle-kit/references/drizzle-kit-command-reference.md)
## Read this when
