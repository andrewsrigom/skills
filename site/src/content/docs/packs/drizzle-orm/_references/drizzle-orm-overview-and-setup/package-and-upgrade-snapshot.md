---
title: "Package And Upgrade Snapshot"
description: "Supporting reference for Drizzle ORM Overview and Setup."
slug: "packs/drizzle-orm/drizzle-orm-overview-and-setup/references/package-and-upgrade-snapshot"
sidebar:
  hidden: true
---
> Pack: [`drizzle-orm`](/packs/drizzle-orm/)
> Parent skill: [Drizzle ORM Overview and Setup](/packs/drizzle-orm/drizzle-orm-overview-and-setup/)
> Source: [`drizzle-orm/drizzle-orm-overview-and-setup/references/package-and-upgrade-snapshot.md`](https://github.com/andrewsrigom/agent-skills/blob/main/drizzle-orm/drizzle-orm-overview-and-setup/references/package-and-upgrade-snapshot.md)
