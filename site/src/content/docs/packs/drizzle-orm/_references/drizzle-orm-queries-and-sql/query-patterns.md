...
slug: "packs/drizzle-orm/drizzle-orm-queries-and-sql/references/query-patterns"
sidebar:
  hidden: true
---
> Pack: [`drizzle-orm`](/packs/drizzle-orm/)
> Parent skill: [Drizzle ORM Queries and SQL](/packs/drizzle-orm/drizzle-orm-queries-and-sql/)
> Source: [`drizzle-orm/drizzle-orm-queries-and-sql/references/query-patterns.md`](https://github.com/andrewsrigom/agent-skills/blob/main/drizzle-orm/drizzle-orm-queries-and-sql/references/query-patterns.md)
## Read this when
