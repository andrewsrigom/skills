---
title: "Serverless And Proxy Notes"
description: "Supporting reference for Drizzle ORM Drivers and Runtimes."
slug: "packs/drizzle-orm/drizzle-orm-drivers-and-runtimes/references/serverless-and-proxy-notes"
sidebar:
  hidden: true
---
> Pack: [`drizzle-orm`](/packs/drizzle-orm/)
> Parent skill: [Drizzle ORM Drivers and Runtimes](/packs/drizzle-orm/drizzle-orm-drivers-and-runtimes/)
> Source: [`drizzle-orm/drizzle-orm-drivers-and-runtimes/references/serverless-and-proxy-notes.md`](https://github.com/andrewsrigom/agent-skills/blob/main/drizzle-orm/drizzle-orm-drivers-and-runtimes/references/serverless-and-proxy-notes.md)
## Read this when
