---
title: "Drizzle ORM Drivers and Runtimes"
...
> Source: [`drizzle-orm/drizzle-orm-drivers-and-runtimes/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/drizzle-orm/drizzle-orm-drivers-and-runtimes/SKILL.md)
...
1. Read [references/database-runtime-matrix.md](/packs/drizzle-orm/drizzle-orm-drivers-and-runtimes/references/database-runtime-matrix/) first.
2. If the task is serverless, edge, proxy, or performance-sensitive, read [references/serverless-and-proxy-notes.md](/packs/drizzle-orm/drizzle-orm-drivers-and-runtimes/references/serverless-and-proxy-notes/).
