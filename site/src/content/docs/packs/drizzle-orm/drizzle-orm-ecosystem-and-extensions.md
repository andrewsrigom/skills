---
title: "Drizzle ORM Ecosystem and Extensions"
...
---
> Pack: [`drizzle-orm`](/packs/drizzle-orm/)
> Source: [`drizzle-orm/drizzle-orm-ecosystem-and-extensions/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/drizzle-orm/drizzle-orm-ecosystem-and-extensions/SKILL.md)
...
1. Read [references/validation-and-schema-generation.md](/packs/drizzle-orm/drizzle-orm-ecosystem-and-extensions/references/validation-and-schema-generation/) first.
2. If the task touches seed, GraphQL, ESLint, Studio package work, Gateway, or Prisma extension work, read [references/ecosystem-tooling-reference.md](/packs/drizzle-orm/drizzle-orm-ecosystem-and-extensions/references/ecosystem-tooling-reference/).
