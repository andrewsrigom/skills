---
title: "Dynamic Icons And Lucide Lab"
description: "Supporting reference for Lucide React Dynamic Icons And Lucide Lab."
slug: "packs/lucide-react/lucide-react-dynamic-icons-and-lucide-lab/references/dynamic-and-lab"
sidebar:
  hidden: true
---
> Pack: [`lucide-react`](/packs/lucide-react/)
> Parent skill: [Lucide React Dynamic Icons And Lucide Lab](/packs/lucide-react/lucide-react-dynamic-icons-and-lucide-lab/)
> Source: [`lucide-react/lucide-react-dynamic-icons-and-lucide-lab/references/dynamic-and-lab.md`](https://github.com/andrewsrigom/agent-skills/blob/main/lucide-react/lucide-react-dynamic-icons-and-lucide-lab/references/dynamic-and-lab.md)
