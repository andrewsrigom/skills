---
title: "Stripe Webhook First Billing State"
...
> Source: [`stripe/stripe-webhook-first-billing-state/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/stripe/stripe-webhook-first-billing-state/SKILL.md)
