---
title: "Stripe Customer Portal Defaults"
...
> Source: [`stripe/stripe-customer-portal-defaults/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/stripe/stripe-customer-portal-defaults/SKILL.md)
