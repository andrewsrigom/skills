---
title: "Playwright Locators Assertions And User Visible Contracts"
...
> Source: [`playwright/playwright-locators-assertions-and-user-visible-contracts/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/playwright/playwright-locators-assertions-and-user-visible-contracts/SKILL.md)
