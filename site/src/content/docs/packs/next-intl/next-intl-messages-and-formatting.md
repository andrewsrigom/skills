---
title: "Next Intl Messages and Formatting"
...
> Source: [`next-intl/next-intl-messages-and-formatting/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/next-intl/next-intl-messages-and-formatting/SKILL.md)
...
1. Read [references/icu-rich-text-and-catalogs.md](/packs/next-intl/next-intl-messages-and-formatting/references/icu-rich-text-and-catalogs/) first.
2. If the task touches formats, validation, or extracted messages, read [references/formatting-validation-and-types.md](/packs/next-intl/next-intl-messages-and-formatting/references/formatting-validation-and-types/).
