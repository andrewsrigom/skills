---
title: "Next Intl Server Runtime"
...
> Source: [`next-intl/next-intl-server-runtime/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/next-intl/next-intl-server-runtime/SKILL.md)
...
1. Read [references/environment-api-matrix.md](/packs/next-intl/next-intl-server-runtime/references/environment-api-matrix/) first.
2. If the task touches static rendering, error files, or tests, read [references/static-rendering-errors-and-tests.md](/packs/next-intl/next-intl-server-runtime/references/static-rendering-errors-and-tests/).
