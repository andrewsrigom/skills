---
title: "Plugin, Types, and Message Loading"
description: "Supporting reference for Next Intl Workflows and Tooling."
slug: "packs/next-intl/next-intl-workflows-and-tooling/references/plugin-types-and-loading"
sidebar:
  hidden: true
---
...
> Source: [`next-intl/next-intl-workflows-and-tooling/references/plugin-types-and-loading.md`](https://github.com/andrewsrigom/agent-skills/blob/main/next-intl/next-intl-workflows-and-tooling/references/plugin-types-and-loading.md)
## Read this when
