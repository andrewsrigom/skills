---
title: "Static Rendering, Error Files, and Tests"
description: "Supporting reference for Next Intl Server Runtime."
slug: "packs/next-intl/next-intl-server-runtime/references/static-rendering-errors-and-tests"
sidebar:
  hidden: true
---
> Pack: [`next-intl`](/packs/next-intl/)
> Parent skill: [Next Intl Server Runtime](/packs/next-intl/next-intl-server-runtime/)
> Source: [`next-intl/next-intl-server-runtime/references/static-rendering-errors-and-tests.md`](https://github.com/andrewsrigom/agent-skills/blob/main/next-intl/next-intl-server-runtime/references/static-rendering-errors-and-tests.md)
## Read this when
