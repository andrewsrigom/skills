---
title: "ICU, Rich Text, and Catalog Structure"
description: "Supporting reference for Next Intl Messages and Formatting."
slug: "packs/next-intl/next-intl-messages-and-formatting/references/icu-rich-text-and-catalogs"
sidebar:
  hidden: true
---
...
> Source: [`next-intl/next-intl-messages-and-formatting/references/icu-rich-text-and-catalogs.md`](https://github.com/andrewsrigom/agent-skills/blob/main/next-intl/next-intl-messages-and-formatting/references/icu-rich-text-and-catalogs.md)
## Read this when
