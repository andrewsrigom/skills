...
slug: "packs/next-intl/next-intl-routing-and-navigation/references/routing-architecture"
sidebar:
  hidden: true
---
...
> Source: [`next-intl/next-intl-routing-and-navigation/references/routing-architecture.md`](https://github.com/andrewsrigom/agent-skills/blob/main/next-intl/next-intl-routing-and-navigation/references/routing-architecture.md)
## Read this when
