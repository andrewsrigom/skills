---
title: "Setup Conventional Commits"
...
> Source: [`engineering/setup-conventional-commits/SKILL.md`](https://github.com/andrewsrigom/agent-skills/blob/main/engineering/setup-conventional-commits/SKILL.md)
