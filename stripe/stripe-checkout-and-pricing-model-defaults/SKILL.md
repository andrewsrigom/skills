---
name: stripe-checkout-and-pricing-model-defaults
...
# Stripe Checkout And Pricing Model Defaults
...
- [Catalog and Checkout defaults](./references/catalog-and-checkout-defaults.md)
