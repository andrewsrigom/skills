---
name: stripe-integration-defaults-and-routing
...
# Stripe Integration Defaults And Routing
...
- [Default architecture and skill boundaries](./references/default-architecture-and-boundaries.md)
